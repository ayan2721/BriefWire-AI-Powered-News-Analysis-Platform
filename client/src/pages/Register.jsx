      ...
      >
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <h1 className="font-serif text-3xl font-bold text-stone-900">Create your account</h1>
          </div>
        </div>
        <p className="mt-1 leading-7 text-stone-600">
          Save articles, analyze news, and build your personalized archive.
        </p>
        ...
        <p className="mt-6 text-sm text-stone-600 text-center">
          ...
          <Link to="/login" className="font-medium text-red-700 hover:text-red-800 hover:underline transition">
            Sign in
          </Link>
        </p>
      </motion.div>
